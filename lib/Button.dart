...
class _ButtonState extends State<Button> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor: widget.isDark==false?Colors.white:Colors.grey[900],
...
class _PagesState extends State<Pages> with WidgetsBindingObserver  {
  ...
  void button(int i) {
    buttonsList.add((data[i].toString().contains("Button") && data[i].toString().contains(widget.room_name))
                ...
                Container(
                  child: Column(
                    children: [
                      (data_value[0][i] == 1) || (data_value[0][i] == "1")
                          ? Text(data[i].toString().split("Button")[0].replaceAll("_", " ") + " ON ",style: GoogleFonts.robotoSlab(color: Colors.white),)
                          : Text(data[i].toString().split("Button")[0].replaceAll("_", " ") + " OFF",style: GoogleFonts.robotoSlab(color: widget.isDark==false?Colors.grey[700]:Colors.white)),
                    ],
                  ),
                ),
              ],
      ...
      child: Container(
          ...
          padding: const EdgeInsets.all(10),
          decoration: widget.isDark==false?
          BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(10),
              boxShadow: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text("Fan Speed  ${data_value[0][i].toString().substring(0,1)}",
                      style: GoogleFonts.robotoSlab(color: widget.isDark==false?Colors.grey[700]:Colors.white)),
                ],
              ),
              Slider(
                activeColor: widget.isDark==false?Colors.blue:Colors.white,
                inactiveColor: widget.isDark==false? Colors.blueGrey[200]:Colors.grey[500],
  ...
  Future<http.Response> update_sync_value() async {
    if(widget.check_url==false){
      ...
      //await http.get('http://${widget.ipAddress}/1/sync/1');
              ...
              result && result2
                ...
                child: Container(
                  ...
                  child: CircularProgressIndicator(
                    backgroundColor: widget.isDark==false?Colors.blue:Colors.grey[700],
                    valueColor: widget.isDark==false?new AlwaysStoppedAnimation<Color>(Colors.white):new AlwaysStoppedAnimation<Color>(Colors.white),
                  ),
                ),
              ),
            ],
